# Generated by Powerlevel10k configuration wizard on 2023-11-06 at 00:10 -05.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=#ED5616
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOCK_ICON='󱓇'
  typeset -g POWERLEVEL9K_HOME_ICON='󰒃'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=#FF9C08
